...
import ListCounts from "./listCount";

class WelcomeGood1 extends Component {
      ...
      <div>
...

        {
          this.state.users.map((item, index) => {
            ...
            return <ListUsers item={item} index={index} counts={this.state.count}/>
        ...
        }
        {
          ...
          this.state.users.map((item, index) => {           
            ...
            return <ListCounts butt={this.add.bind(this)} item={item} index={index}/>
          })
        }
        <br />
